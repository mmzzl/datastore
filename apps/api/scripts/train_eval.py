...
def parse_args(argv: Optional[List[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--lgbm-n-estimators", default="500,1000",
                        help="Comma-separated n_estimators values (e.g., 500,1000)")
    parser.add_argument("--lgbm-lr", default="0.01,0.05",
                        help="Comma-separated learning_rate values (e.g., 0.01,0.005)")
    parser.add_argument("--lgbm-num-leaves", default="31,63",
                        help="Comma-separated num_leaves values (e.g., 31,63)")
    parser.add_argument("--lgbm-subsample", default="0.8",
                        help="Comma-separated subsample values (e.g., 0.8,0.9)")
    parser.add_argument("--lgbm-colsample-bytree", default="0.8",
